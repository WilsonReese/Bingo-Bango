...
task({ :sample_data => :environment }) do
  ...
  Reservation.create(
    user: user1, 
    theater: theater1, 
    start_time: Time.current.beginning_of_day + 12.hours, 
    end_time: Time.current.beginning_of_day + 13.hours, 
    duration: 1.0, 
    number_guests: 2, 
    content_choice: 'BYOC', 
    status: 'confirmed'
  ...
  Reservation.create(
    user: user1, 
    theater: theater1, 
    start_time: Time.current.beginning_of_day + 15.hours, 
  ...
  Reservation.create(
    user: user1, 
    theater: theater2, 
    start_time: Time.current.beginning_of_day + 19.hours, 
    end_time: Time.current.beginning_of_day + 21.hours, 
    duration: 2.0, 
    number_guests: 6, 
  ...
  Reservation.create(
    user: user1, 
    theater: theater2, 
    start_time: Time.current.beginning_of_day + 22.hours, 
    end_time: Time.current.beginning_of_day + 23.hours, 
    duration: 2.0, 
    number_guests: 6, 
    content_choice: 'New Release', 
    status: 'confirmed'
  ...
  Reservation.create(
    ...
    end_time: Time.current.beginning_of_day + 20.hours, 
    duration: 2.0, 
    number_guests: 5, 
    content_choice: 'BYOC', 
    status: 'confirmed'
